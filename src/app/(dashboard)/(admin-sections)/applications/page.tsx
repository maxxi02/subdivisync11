...
const ApplicationsPage = () => {
  ...
  const handleApprove = async (inquiry: InquiryWithProperty) => {
    ...
    try {
      ...
      // Update inquiries: approve the selected one, reject all others
      const updatedInquiries = currentProperty.inquiries.map((inq: Inquiry) => {
        if (inq.email === inquiry.email && inq.phone === inquiry.phone) {
          ...
          // Auto-reject other pending inquiries
          return {
            ...inq,
            status: "rejected",
            rejectionReason: "Property has been leased to another applicant",
          };
        }
        return inq;
      });
      ...
      if (updateData.success) {
        ...
        showNotification(
          "success",
          "Inquiry approved, payment plan created, and other pending inquiries rejected automatically"
        );
      } else {
